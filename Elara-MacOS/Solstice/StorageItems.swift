...
let sounds = [
    NotificationSound(fileName: "Sci-Fi_mac.wav", friendlyName: "Nebula"),
    NotificationSound(fileName: "Ringer_mac.wav", friendlyName: "Dialback"),
    NotificationSound(fileName: "Fantasy_mac.wav", friendlyName: "Lumos"),
    NotificationSound(fileName: "Relaxing_mac.wav", friendlyName: "Serenity (Default)")
]
